...
console.log('Format Node Input Items:', $input.all().length);
...
if (dateQuery.intent === 'request_appointment') {
    ...
    if (collisions.length > 0) {
        ...
        const userMsg = '✅ *Request Sent*\n\nYour appointment request for ' + dateQuery.specificTimeLabel + ' has been sent for approval.';
...
print("Logic fixed and logging added.")
